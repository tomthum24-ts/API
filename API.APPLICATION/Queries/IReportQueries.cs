...
namespace API.APPLICATION.Queries
{
    ...
    {
        public Task<IEnumerable<ReportReplaceInfoHTMLDTO>> GetInformationReportReplaceInfo(ReportReplaceInfoFilterParam param);
    }
    ...
    public class ReportQueries : IReportQueries
    {
        ...
        public async Task<IEnumerable<ReportReplaceInfoHTMLDTO>> GetInformationReportReplaceInfo(ReportReplaceInfoFilterParam param)
        {
