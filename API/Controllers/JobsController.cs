...
namespace API.Controllers
{
    ...
    public class JobsController : ControllerBase
    {
        ...
        public JobsController(IMediator mediator, IMapper mapper, IJobsServices jobsServices)
        {
            _mediator = mediator;
            _mapper = mapper;
        ...
        {
            var methodResult = new MethodResult<JobsResponseViewModel>();
            ...
            methodResult.Result = _mapper.Map<JobsResponseViewModel>(query);
            return Ok(methodResult);
        }
